...
namespace _2._5D_FYP
{
    public class Ground : Entity
    {
        ...
        public override void LoadContent()
        {
            ...
            {
                new VertexPositionTexture(new Vector3(-groundWidth, -100, groundHeight), new Vector2(0, theight)),
                new VertexPositionTexture(new Vector3(-groundWidth, -100, -groundHeight), new Vector2(0,0)),
                new VertexPositionTexture(new Vector3(groundWidth, -100, groundHeight), new Vector2(twidth, theight)),

                new VertexPositionTexture(new Vector3(groundWidth, -100, groundHeight), new Vector2(twidth, theight)),
                new VertexPositionTexture(new Vector3(-groundWidth, -100, -groundHeight), new Vector2(0, 0)),
                new VertexPositionTexture(new Vector3(groundWidth, -100, -groundHeight), new Vector2(twidth, 0))
            };
