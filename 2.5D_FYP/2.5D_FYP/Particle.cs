...
namespace _2._5D_FYP
{
    public class Particle
    {
        ...
        public void LoadContent()
        {
            ...
            {
                case 0:
                    model = Game1.Instance().Content.Load<Model>("Models//sphereGrey");
                    break;
                case 1:
                    model = Game1.Instance().Content.Load<Model>("Models//sphereFire");
                    break;                    
                case 2:
                    model = Game1.Instance().Content.Load<Model>("Models//sphereOrange");
                    break;
            }        
        }
